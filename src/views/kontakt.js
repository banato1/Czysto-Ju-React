  ...
  return (
    <div className={styles['container']}>
          ...
          <div className={styles['Content-container']}>
            <h2 className={styles['text01']}>
              ...
              <a href="mailto:kontakt@cysztojuz.pl?subject=">
                <span className={styles['text05']}>kontakt@cysztojuz.pl</span>
              </a>
            </h2>
          </div>
      ...
      <div id="main-section" className={styles['Main']}>
        <h1 className={styles['text06']}>Naszy usÅugi</h1>
        ...
        <h1 className={styles['text07']}>Skontaktuj siÄ z nami !</h1>
        <input
          type="text"
          placeholder="Imie"
        ...
        <div className={styles['Menu']}>
          ...
          <div className={styles['container6']}>
            <span className={styles['text08']}>
              <span className={styles['text09']}>O n</span>
              <Link to="/onas"></Link>
              <span className={styles['text10']}>as</span>
            </span>
          ...
          <div className={styles['Follow-container']}>
            <span className={styles['text11']}>Za subskrybuj nas</span>
