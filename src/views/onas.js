          ...
          <div className={styles['Content-container']}>
            <h2 className={styles['text01']}>
              ...
              <span className={styles['text03']}>
                ...
                najnowoczeÅniejsze narzÄdzia i materiaÅy, aby stworzyÄ czyste i
                zdrowe Årodowisko dla klienta.
                <span
                  dangerouslySetInnerHTML={{
                    __html: ' ',
                  }}
        ...
        <div className={styles['Menu']}>
          ...
          <div className={styles['container13']}>
            <span className={styles['text07']}>
              <span className={styles['text08']}>O n</span>
              <Link to="/onas"></Link>
              <span className={styles['text09']}>as</span>
            </span>
          ...
          <div className={styles['Follow-container']}>
            <span className={styles['text10']}>Za subskrybuj nas</span>
